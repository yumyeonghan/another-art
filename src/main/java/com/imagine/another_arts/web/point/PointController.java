...
import com.imagine.another_arts.web.point.dto.request.PointChargeRequest;
import com.imagine.another_arts.web.point.dto.response.PointChargeResponse;
...
public class PointController {
    ...
    public PointChargeResponse pointChargeUserInf(@SessionAttribute(name = SessionConst.LOGIN_USER, required = false) UserDto loginUser) {
    ...
    public ResponseEntity<Void> pointCharge(@RequestBody PointChargeRequest pointChargeRequest) {
