...
@Data
@NoArgsConstructor
public class GeneralArtResponseDto {
    private Long artId; // 작품 ID(PK)
    private Integer likeCount; // 작품 좋아요 수
    ...
    public GeneralArtResponseDto(Art art, List<String> hashtag){
        this.artId = art.getId();
        this.likeCount = art.getLikeArtList().size();
