            ...
            <div class="col-md-6 position-static d-block p-3 text-black">
                <div class="row g-3">
                    <div :class="col_style" class="mb-4">
                        ...
                        <div class="btn-group form-control" style="height: 120px; border: none;" role="group"
                            ...
                            <button type="button" @click="$emit('setSaleType', 'auction')" class="btn btn-secondary">
                                <div class="mb-2">
                ...
                <div>
                    <div class="row g-3">
                        ...
                        <div :class="col_style" class="mb-2">
                            <div class="row">
                                <label for="price" class="form-label">경매시작 가격</label>
    ...
    methods: {
        ...
        registerArt() {
            ...
            axios.post('/api/art', formData, {
                ...
                this.$store.commit('setIsArtRegistered', 1);
                alert('등록 완료');
                this.$router.push('/');
            }).catch((err) => {
